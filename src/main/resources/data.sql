...
INSERT INTO book (id, name, page_count, isbn, genre_id, author_id, publish_year, publisher_id, view_count, descr)
VALUES (1101, 'Капитанская дочка', 233, '978-5-91982-527-2', 124, 111, 1836, 151, 10,
       ...
       (1102, 'Лолита', 418, '5-280-01639-X', 135, 117, 1991, 153, 15,
       ...
       (1103, 'Приключения Оливера Твиста', 544, '978-5-17-113039-8', 126, 116, 2019, 152, 1,
       ...
       (1104, 'Левша', 88, '978-5-91921-735-0', 138, 117, 1882, 150, 0, 'Знаменитый сказ Лескова о тульском левше, подковавшем "аглицкую" блоху, с иллюстрациями заслуженного художника России Михаила Петрова.
Книга снабжена подробными примечаниями, которые разъясняют не только особенности лесковского словоупотребления, но и исторические события, персоналии и географические объекты.'),
       (1105, 'Азазель', 240, '5-8159-0494-5', 124, 112, 1991, 151, 88,
       ...
       (1106, 'Собачья смерть', 432, '978-5-8159-1697-5', 126, 112, 2005, 153, 14,
       ...
       (1107, 'Евгений Онегин', 223, '978-5-00195-977-9', 124, 111, 1831, 151, 112,
       ...
       (1108, 'Большие надежды', 560, '978-5-00112-011-7', 124, 116, 1876, 152, 3,
